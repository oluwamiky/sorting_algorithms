...
int lom_parts(int *array, size_t size, int left, int right);
...
/**
 * lom_parts - Order a subset of an array of integers according to
...
void lom_sort(int *array, size_t size, int left, int right)
{
	...
	if (right - left > 0)
	{
		part = lom_parts(array, size, left, right);
